...
export type BookExercisesDocument = BookExercises & Document;

@Schema({ timestamps: true })
export class BookExercises {
    @Prop({
...
export const BookExercisesSchema = SchemaFactory.createForClass(BookExercises);
