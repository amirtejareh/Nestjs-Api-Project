...
export class EssayQuestionService {
  constructor(
    private readonly essayQuestionRepository: EssayQuestionRepository
  ) {}
  ...
  create(
    ...
    return this.essayQuestionRepository.create(
      res,
      pdfFiles,
  ...
  async findBasedOnBooks(books: string[]) {
    ...
    return this.essayQuestionRepository.findBasedOnBooks(books);
  }
  ...
  update(
    ...
    return this.essayQuestionRepository.update(
      res,
      pdfFiles,
      id,
